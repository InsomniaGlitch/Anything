...
public class search {
    ...
    public search(Set<notebook> notebooks) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    }

    public search(Set<notebook> notebooks, List<Criterion> criterionList) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    ...
    public Map<String, String> descriptionsProperties(){
        ...
        map.put("operatingSystem", "Тип ОС");
        map.put("price", "Цена");
...
class Criterion {
    ...
    public static Criterion startGetting(Scanner scanner, String property, boolean isQuantitative) {
        ...
        if (isQuantitative) {
            ...
            String min = "Введите минимальное значение: ";
            String max = "Введите максимальное значение: ";
